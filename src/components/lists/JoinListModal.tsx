    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <div className="flex justify-between items-start mb-4">
          <div>
            <h2 className="text-xl font-bold">Entrar em Lista</h2>
            <p className="text-sm text-gray-600">Digite o código de compartilhamento</p>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="ABC123"
              maxLength={6}
              className="w-full border border-gray-300 rounded-lg px-4 py-3 text-center text-2xl font-mono uppercase tracking-widest focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              disabled={loading}
              autoFocus
            />
            {validating && (
          ...
          <button
            onClick={handleClose}
            disabled={loading}
            className="w-full bg-white text-gray-700 py-2 px-4 rounded-lg border border-gray-300 hover:bg-gray-50 disabled:opacity-50"
          >
            Cancelar
          </button>
        </div>
