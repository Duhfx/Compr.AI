          ...
          <div className="flex items-center justify-between gap-3 mb-1">
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              ...
              <button
                ...
                className="w-10 h-10 bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 text-white rounded-full active:scale-95 transition-all shadow-md flex items-center justify-center"
                title="Chat com IA"
              >
