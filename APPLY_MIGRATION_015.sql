-- INSTRUÇÕES: Execute este SQL no Supabase Studio (SQL Editor) ou via CLI:
-- CLI: supabase db push
-- Studio: Cole este conteúdo no SQL Editor e execute
...
-- Agora os itens serão removidos do histórico quando desmarcados como comprados
